...
2. **Complete** (for SOP answers): Does the answer include ALL major steps/points from the context?
...
- Set "is_valid" to true ONLY if ALL three criteria above are satisfied.
- Set "is_valid" to false if the answer hallucinates, misses important steps, or is off-topic.
